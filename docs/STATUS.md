...
| | v1.0.0 | v1.1.0 | v1.2.0 | v1.3.0 | v1.6.0 | v1.7.0 |
| --- | --- | --- | --- | --- | --- | --- |
| grand totals matched | — | 50/50 | 50/50 | 50/50 | 50/50 | **50/50** |
| all line-item codes found | — | 49/49 | 49/49 | 49/49 | 49/49 | **49/49** |
| each amount on its code's row | — | 52/52 | 52/52 | 52/52 | 52/52 | **52/52** |
| `#Error` string preserved | — | 50/50 | 50/50 | 50/50 | 50/50 | **50/50** |
| documents emitting a real table | 0/50 | 0/50 | 3/50 | 49/50 | 49/50 | **49/50** |
| headline total recovered | — | 1/50 | 1/50 | 44/50 | 44/50 | **44/50** |
| documents with no table and no note | — | 50/50 | 47/50 | 0/50 | 0/50 | **0/50** |
| review markers vs actual misses | — | — | — | 6 = 6 | 6 = 6 | **6 = 6** |
| independent audit defects | 121 | 0 data errors | 0 data errors | 0 data errors | 0 data errors | 0 data errors |

1.4.0 and 1.5.0 were ship-readiness and rename cycles and changed no conversion
behaviour, so they carry v1.3.0's column. 1.6.0 and 1.7.0 each changed several
conversion paths and moved nothing here. That is deliberate rather than lucky:
the corpus is single-page scanned forms, **none of which carries a PDF outline**,
so 1.7.0's heading work exercises the size-inference fallback exclusively — and
the corpus staying flat is the evidence that fallback is untouched.
...
and a diagnostic block proved to contain nothing of the document. A further 52
